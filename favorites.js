...
function updateStats() {
    ...
    if (totalArticlesEl && allArticles) totalArticlesEl.innerText = allArticles.length;
    if (totalCategoriesEl && CATEGORIES_LIST) totalCategoriesEl.innerText = CATEGORIES_LIST.length;
