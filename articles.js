...
function openArticleModal(article) {
    ...
    modalContent.innerHTML = `
        ...
        <img src="${article.image}" alt="${article.titre}" style="width:100%; border-radius:16px; margin:16px 0;" onerror="this.src='https://placehold.co/600x400?text=Image+indisponible'" loading="lazy">
    ...
    if (typeof userProfile !== 'undefined' && userProfile) {
        userProfile.recordArticleRead(article.titre);
    }
}
...
console.log('✅ Gestion des articles chargée');